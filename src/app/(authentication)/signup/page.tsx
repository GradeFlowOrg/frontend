        ...
        <form className="space-y-4" onSubmit={handleSubmit(onSubmit)} noValidate>
              ...
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    className={`w-full pr-10 ${errors.confirmPassword ? "border-red-500 focus:border-red-500 focus:ring-red-500/20 dark:border-red-400" : ""}`}
                  />
                  <button
                    type="button"
          ...
          <div className="flex flex-col-reverse gap-2 pt-2 sm:flex-row sm:justify-between">
            <Button
              type="button"
              onClick={prevStep}
              className={`mt-0 w-full border border-[#c7d8ff] bg-white text-[#0F2854] hover:bg-[#eef4ff] hover:text-[#0046FF] dark:border-white/15 dark:bg-[#0b1220] dark:text-slate-200 dark:hover:bg-white/10 dark:hover:text-white sm:w-auto sm:min-w-28 ${step === 0 ? "hidden" : ""}`}
            >
              Back
            </Button>
