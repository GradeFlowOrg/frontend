        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className='flex gap-2 min-[390px]:gap-6'>
              ...
              <Link href={'/signup'} className="bg-[#0046FF] w-[90px] h-[40px] flex items-center justify-center font-medium text-white font-bold rounded-[10px] border border-[#0046FF] cursor-pointer max-[390px]:text-[12px] max-[390px]:w-[60px]  max-[390px]:h-[30px] tracking-normal text-[white] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md hover:bg-white hover:text-[#0046FF] text-[14px]">Sign up</Link>
            </div>
          </div>
        </div>
      </div>
