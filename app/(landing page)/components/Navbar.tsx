...
export default function Navbar() {
  return (
    <nav className="text-white p-4 bg-[#3723875f] backdrop-blur-[12px] fixed w-full z-10 border border-[rgba(0,0,0,0.05)]">
